        ...
        public static void Seed(AppDbContext context)
        {
            if (!context.Courses.Any())
            {
                ...
                (
                    ...
                    new Course { Major = "Information Technology", CourseTitle = "Business Application Programming", CourseDescription = "Business application development using a non-object oriented programming language. ", CourseImageThumbnailUrl = "", CourseNumber = "310", MajorShortCode = "IT" },
